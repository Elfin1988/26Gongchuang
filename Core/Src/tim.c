...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = CHASSIS_3650_FR_PWM_Pin;
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PA6     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = CHASSIS_3650_FL_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD12     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = BLOCK_2430_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(BLOCK_2430_PWM_GPIO_Port, &GPIO_InitStruct);
    ...
    PB9     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = CHASSIS_3650_RL_PWM_Pin|CHASSIS_3650_RR_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    GPIO_InitStruct.Pin = SERVO_GRIPPER_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM8;
    HAL_GPIO_Init(SERVO_GRIPPER_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM13_MspPostInit 0 */
    ...
    PF8     ------> TIM13_CH1
    */
    GPIO_InitStruct.Pin = SERVO_BLOCK_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM13;
    HAL_GPIO_Init(SERVO_BLOCK_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM15_MspPostInit 0 */
    ...
    PA2     ------> TIM15_CH1
    */
    GPIO_InitStruct.Pin = SERVO_ELBOW_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_TIM15;
    HAL_GPIO_Init(SERVO_ELBOW_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM24_MspPostInit 0 */
    ...
    PF12     ------> TIM24_CH2
    */
    GPIO_InitStruct.Pin = FRICTION_3650_A_PWM_Pin|FRICTION_3650_B_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
